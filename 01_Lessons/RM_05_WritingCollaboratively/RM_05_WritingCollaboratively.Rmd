...
Open RStudio an click on \textsc{File -> New Project}. <!-- comment in RMarkdown-->
...
1. In your R Markdown file, use a new line for each sentence (as you can see in this _.Rmd_ document). 
