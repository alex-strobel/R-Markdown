...
We recommend using an own *.Rmd* file for each section and put them together in a master document via, e.g.,
...
Yet, we still have to find out whether this works with the *papaja* package.